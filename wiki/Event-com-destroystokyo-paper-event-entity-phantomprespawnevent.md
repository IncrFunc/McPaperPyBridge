...
- Java 类: `com.destroystokyo.paper.event.entity.PhantomPreSpawnEvent`
- 父类: `com.destroystokyo.paper.event.entity.PreCreatureSpawnEvent`
- Python 订阅名: `PhantomPreSpawnEvent`
- Python 常量: `Events.PHANTOM_PRE_SPAWN`
- 可取消: 是
- 可能关联玩家: 没有已知玩家 getter
- 处理器列表定义于: `com.destroystokyo.paper.event.entity.PreCreatureSpawnEvent`
- [Paper 官方 Javadoc](https://jd.papermc.io/paper/1.16.5/com/destroystokyo/paper/event/entity/PhantomPreSpawnEvent.html)
...
| `spawningEntity` | 实体摘要 | `getSpawningEntity()` | `org.bukkit.entity.Entity` | `com.destroystokyo.paper.event.entity.PhantomPreSpawnEvent` |
| `type` | 字符串 | `getType()` | `org.bukkit.entity.EntityType` | `com.destroystokyo.paper.event.entity.PreCreatureSpawnEvent` |

[[Data-Format|通用字段、数据格式和限制]] · [[Event-com-destroystokyo-paper-event-entity-phantomprespawnevent-en|English]]
