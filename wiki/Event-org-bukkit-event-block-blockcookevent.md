...
- Java 类: `org.bukkit.event.block.BlockCookEvent`
- 父类: `org.bukkit.event.block.BlockEvent`
- Python 订阅名: `BlockCookEvent`
- Python 常量: `Events.BLOCK_COOK`
- 可取消: 是
- 可能关联玩家: 没有已知玩家 getter
- 处理器列表定义于: `org.bukkit.event.block.BlockCookEvent`
- [Paper 官方 Javadoc](https://jd.papermc.io/paper/1.16.5/org/bukkit/event/block/BlockCookEvent.html)
...
[[Data-Format|通用字段、数据格式和限制]] · [[Event-org-bukkit-event-block-blockcookevent-en|English]]
