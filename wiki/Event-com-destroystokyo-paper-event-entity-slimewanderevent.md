...
- Java 类: `com.destroystokyo.paper.event.entity.SlimeWanderEvent`
- 父类: `com.destroystokyo.paper.event.entity.SlimePathfindEvent`
- Python 订阅名: `SlimeWanderEvent`
- Python 常量: `Events.SLIME_WANDER`
- 可取消: 是
- 可能关联玩家: 取决于实际对象
- 处理器列表定义于: `com.destroystokyo.paper.event.entity.SlimePathfindEvent`
- [Paper 官方 Javadoc](https://jd.papermc.io/paper/1.16.5/com/destroystokyo/paper/event/entity/SlimeWanderEvent.html)
...
[[Data-Format|通用字段、数据格式和限制]] · [[Event-com-destroystokyo-paper-event-entity-slimewanderevent-en|English]]
