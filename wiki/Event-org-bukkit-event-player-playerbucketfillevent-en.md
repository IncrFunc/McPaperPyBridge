...
- Java class: `org.bukkit.event.player.PlayerBucketFillEvent`
- Parent class: `org.bukkit.event.player.PlayerBucketEvent`
- Python subscription: `PlayerBucketFillEvent`
- Python constant: `Events.PLAYER_BUCKET_FILL`
- Cancellable: Yes
- Player available: Possible at runtime
- HandlerList owner: `org.bukkit.event.player.PlayerBucketFillEvent`
- [Official Paper Javadoc](https://jd.papermc.io/paper/1.16.5/org/bukkit/event/player/PlayerBucketFillEvent.html)
...
[[Data-Format-en|Wire format and limits]] · [[Event-org-bukkit-event-player-playerbucketfillevent|中文]]
