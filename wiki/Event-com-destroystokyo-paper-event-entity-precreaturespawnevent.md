...
- Java 类: `com.destroystokyo.paper.event.entity.PreCreatureSpawnEvent`
- 父类: `org.bukkit.event.Event`
- Python 订阅名: `PreCreatureSpawnEvent`
- Python 常量: `Events.PRE_CREATURE_SPAWN`
- 可取消: 是
- 可能关联玩家: 没有已知玩家 getter
- 处理器列表定义于: `com.destroystokyo.paper.event.entity.PreCreatureSpawnEvent`
- [Paper 官方 Javadoc](https://jd.papermc.io/paper/1.16.5/com/destroystokyo/paper/event/entity/PreCreatureSpawnEvent.html)
...
[[Data-Format|通用字段、数据格式和限制]] · [[Event-com-destroystokyo-paper-event-entity-precreaturespawnevent-en|English]]
