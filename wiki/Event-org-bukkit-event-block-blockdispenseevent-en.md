...
- Java class: `org.bukkit.event.block.BlockDispenseEvent`
- Parent class: `org.bukkit.event.block.BlockEvent`
- Python subscription: `BlockDispenseEvent`
- Python constant: `Events.BLOCK_DISPENSE`
- Cancellable: Yes
- Player available: No known player getter
- HandlerList owner: `org.bukkit.event.block.BlockDispenseEvent`
- [Official Paper Javadoc](https://jd.papermc.io/paper/1.16.5/org/bukkit/event/block/BlockDispenseEvent.html)
...
[[Data-Format-en|Wire format and limits]] · [[Event-org-bukkit-event-block-blockdispenseevent|中文]]
