...
- Java class: `org.bukkit.event.inventory.InventoryClickEvent`
- Parent class: `org.bukkit.event.inventory.InventoryInteractEvent`
- Python subscription: `InventoryClickEvent`
- Python constant: `Events.INVENTORY_CLICK`
- Cancellable: Yes
- Player available: Possible at runtime
- HandlerList owner: `org.bukkit.event.inventory.InventoryClickEvent`
- [Official Paper Javadoc](https://jd.papermc.io/paper/1.16.5/org/bukkit/event/inventory/InventoryClickEvent.html)
...
@bridge.on(Events.INVENTORY_CLICK)
def on_event(event):
...
[[Data-Format-en|Wire format and limits]] · [[Event-org-bukkit-event-inventory-inventoryclickevent|中文]]
