...
- Java 类: `org.bukkit.event.player.PlayerBucketEmptyEvent`
- 父类: `org.bukkit.event.player.PlayerBucketEvent`
- Python 订阅名: `PlayerBucketEmptyEvent`
- Python 常量: `Events.PLAYER_BUCKET_EMPTY`
- 可取消: 是
- 可能关联玩家: 取决于实际对象
- 处理器列表定义于: `org.bukkit.event.player.PlayerBucketEmptyEvent`
- [Paper 官方 Javadoc](https://jd.papermc.io/paper/1.16.5/org/bukkit/event/player/PlayerBucketEmptyEvent.html)
...
[[Data-Format|通用字段、数据格式和限制]] · [[Event-org-bukkit-event-player-playerbucketemptyevent-en|English]]
