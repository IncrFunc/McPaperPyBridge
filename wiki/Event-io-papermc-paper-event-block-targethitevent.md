...
- Java 类: `io.papermc.paper.event.block.TargetHitEvent`
- 父类: `org.bukkit.event.entity.ProjectileHitEvent`
- Python 订阅名: `TargetHitEvent`
- Python 常量: `Events.TARGET_HIT`
- 可取消: 是
- 可能关联玩家: 取决于实际对象
- 处理器列表定义于: `io.papermc.paper.event.block.TargetHitEvent`
- [Paper 官方 Javadoc](https://jd.papermc.io/paper/1.16.5/io/papermc/paper/event/block/TargetHitEvent.html)
...
| `signalStrength` | 数字 | `getSignalStrength()` | `int` | `io.papermc.paper.event.block.TargetHitEvent` |

[[Data-Format|通用字段、数据格式和限制]] · [[Event-io-papermc-paper-event-block-targethitevent-en|English]]
